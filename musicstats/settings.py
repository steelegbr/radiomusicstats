...
ALLOWED_HOSTS = ['api.radiomusicstats.co.uk']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'musicstats_api',
        'USER': 'musicstats_api',
        'PASSWORD': 'xW84&2^Jr!YK',
        'HOST': 'localhost',
        'PORT': '3306',
    }
}

# Override MySQL key length check
...
STATIC_URL = '/static/'
STATIC_ROOT = '/var/www/musicstats-django/static/'

# Media Root

MEDIA_URL = '/media/'
MEDIA_ROOT = '/var/www/musicstats-django/media/'
...
CORS_ORIGIN_WHITELIST = (
        'https://wordpress.internal.technicallyminded.co.uk',
        'https://www.solidradio.co.uk'
)
